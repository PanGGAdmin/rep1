...
CREATE TABLE `checkdetailed` (
  ...
  `yingkuiCount` double(18,2) DEFAULT NULL,
...
insert  into `checkdetailed`(`clId`,`columnId`,`materielId`,`zhangmianCount`,`yingkuiCount`,`pandianCount`,`price`,`yingkuiPrice`,`cause`) values ('20180102001',1,'2',40.00,1.00,41.00,50.000000,-50.000000,'啦啦啦'),('20180103001',1,'1',50.00,-1.00,49.00,40.000000,40.000000,'哈哈哈');
...
/*Table structure for table `ckwl` */

DROP TABLE IF EXISTS `ckwl`;

CREATE TABLE `ckwl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `maid` int(20) DEFAULT NULL COMMENT '物料id',
  `Number` int(11) DEFAULT NULL COMMENT '物料数量',
  `wterid` int(11) DEFAULT NULL COMMENT '仓库id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `ckwl` */

insert  into `ckwl`(`id`,`maid`,`Number`,`wterid`) values (1,1,27,1),(2,2,23,1),(3,1,5,2),(4,2,6,2);
...
insert  into `dropout`(`Id`,`DiaoChuCangku`,`DiaoRuCangKu`,`DanJvRiQi`,`DanJvHaoMan`,`ZhiDanRenYuan`,`FuHeRenYuan`,`type`) values (1,'原料仓','成品仓','2018-05-05','20180505001','admin','admin',0),(2,'原料仓','成品仓','2018-05-05','20180505002','admin','admin',0),(3,'原料仓','成品仓','2018-05-05','20180505005','admin','admin',1),(4,'原料仓','成品仓','2018-05-05','20180505003','admin','admin',0),(5,'原料仓','成品仓','2018-05-05','20180505004','admin','admin',1);
...
insert  into `dropouts`(`Id`,`Did`,`Bid`,`ShuLiang`,`BeiZhu`) values (1,'20180505001','1','1','BeiZhu'),(2,'20180505002','2','2','BeiZhu'),(3,'20180505001','1','1','1'),(4,'20180505002','2','2','1'),(5,'20180505003','2','1','2'),(6,'20180505004','2','2','2'),(7,'20180505005','2','2','2');
...
CREATE TABLE `dsdssalemain` (
  ...
  `custId` varchar(50) DEFAULT NULL COMMENT '客户id（外键，主键客户表）',
  ...
  `wareId` varchar(50) DEFAULT NULL COMMENT '仓库id（外键，主键仓库表）',
...
CREATE TABLE `outinto` (
  ...
  `purchasePersonnelId` varchar(11) DEFAULT NULL,
  `projectId` varchar(11) DEFAULT NULL,
  `ordersPersonnelId` varchar(11) DEFAULT NULL,
  `reviewPersonnelId` varchar(11) DEFAULT NULL,
...
insert  into `outinto`(`documentsNo`,`documentsDate`,`Foreigns`,`tax`,`documentNo`,`note`,`supplierId`,`storageTypeId`,`houseId`,`purchasePersonnelId`,`projectId`,`ordersPersonnelId`,`reviewPersonnelId`,`restocking`,`billtype`) values ('20180506001','2018-05-06',1,1,NULL,NULL,'CSXL',1,1,'李大海',NULL,'Admin','Admin2',1,'采购入库单'),('20180506004','2018-05-06',NULL,0,NULL,'','CSXL',2,2,'李大海',NULL,'Admin','Admin2',NULL,'采购入库单'),('20180506005','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506010','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506011','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506012','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506013','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506014','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506015','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506016','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506017','2018-05-06',NULL,0,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506018','2018-05-06',NULL,1,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506019','2018-05-06',NULL,0,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506020','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单'),('20180506021','2018-05-06',NULL,NULL,NULL,'','CSXL',NULL,1,'李大海','','Admin','Admin2',NULL,'采购入库单');
...
CREATE TABLE `outintodetails` (
  ...
  `documentsId` varchar(20) DEFAULT NULL,
...
insert  into `outintodetails`(`detailsId`,`materialsId`,`documentsId`,`ordersType`,`ordersId`,`apportionment`,`number`,`priceBeforeDiscount`,`disCount`,`gifts`,`apportionmentNote`,`taxrate`) values (2,1,'20180506001','','',NULL,1,100,1,0,NULL,0.16),(3,1,'20180506001','','',NULL,1,100,1,0,NULL,0.16),(4,1,'20180506001','','',NULL,1,100,1,0,NULL,0.16),(5,1,'20180506001','','',NULL,1,100,1,0,NULL,0.16),(7,1,'20180506004','','',NULL,1,100,1,0,NULL,0.16),(17,1,'20180506010','','',NULL,1,100,1,0,NULL,0.16),(18,1,'20180506010','','',NULL,1,100,1,0,NULL,0.16),(19,1,'20180506010','','',NULL,1,100,1,0,NULL,0.16),(20,1,'20180506005','','',NULL,1,100,1,0,NULL,0.16),(21,1,'20180506005','','',NULL,1,100,1,0,NULL,0.16),(22,1,'20180506011','','',NULL,1,100,1,0,NULL,0.16),(23,1,'20180506012','','',NULL,1,100,1,0,NULL,0.16),(24,1,'20180506013','','',NULL,1,100,1,0,NULL,0.16),(25,1,'20180506014','','',NULL,1,100,1,0,NULL,0.16),(26,1,'20180506015','','',NULL,1,100,1,0,NULL,0.16),(27,1,'20180506016','','',NULL,10,100,1,0,NULL,0.16),(30,1,'20180506017','','',NULL,1,100,1,0,NULL,0.16),(31,1,'20180506017','','',NULL,1,100,1,0,NULL,0.16),(33,1,'20180506018','','',NULL,1,100,1,0,NULL,0.16),(34,1,'20180506018','','',NULL,10,100,1,0,NULL,0.16),(35,1,'20180506019','','',NULL,1,100,1,0,'null',NULL),(38,1,'20180506020','','',NULL,1,100,1,0,'null',NULL),(39,1,'20180506020','','',NULL,1,100,1,0,'null',NULL),(40,1,'20180506021','','',NULL,1,100,1,0,'null',NULL),(41,1,'20180506021','','',NULL,1,100,1,0,'null',NULL);
...
insert  into `payforcontent`(`LanHao`,`FundbillID`,`SourceName`,`YuandanDate`,`YuandanID`,`Fapiao`,`TradingDX`,`TradingDXName`,`DeptFromID`,`DeptFrom`,`Purchasers`,`ProjectName`,`CurrID`,`ExchRate`,`originmoney`,`Balance`,`Discountmoney`,`Payformoney`,`Flushingmoney`) values (0,'20141225001','SourceName',NULL,'YuandanID','Fapiao',1,'TradingDXName',1,'DeptFrom','Purchasers','ProjectName','CurrID',1.0000,1.0000,1.0000,1.0000,1.0000,1.0000),(1,'12123','1','2011-11-11',NULL,'1',1,'1',1,'1','1','1','1',1.0000,1.0000,1.0000,1.0000,1.0000,1.0000),(2,'20141225001','SourceName',NULL,'YuandanID','Fapiao',1,'TradingDXName',1,'DeptFrom','Purchasers','ProjectName','CurrID',1.0000,1.0000,1.0000,1.0000,1.0000,1.0000);
...
insert  into `requisitions`(`billNo`,`billDate`,`billStyleID`,`billStatus`,`salesID`,`departID`,`maker`,`permitter`,`headerID`,`footerID`,`userDef1`,`userDef2`,`remark`,`deleteStatus`) values ('2018050201','2018-05-02','2','未结案',1,1,'Admin','Admin',1,1,'','','remark',NULL),('2018050202','2018-05-02','2','未结案',1,1,'Admin','Admin',1,1,'','','remark',NULL),('2018050203','2018-05-02','2','未结案',1,1,'1','Admin',NULL,NULL,'','','',NULL),('2018050701','2018-05-07','1','未结案',1,1,'1','1',NULL,NULL,'','','',0),('2018050801','2018-05-08','1','未结案',1,1,'1','1',NULL,NULL,'','','',1),('2018050802','2018-05-08','2','未结案',1,1,'1','Admin',NULL,NULL,'','','',NULL),('2018050803','2018-05-08','2','未结案',1,1,'1','1',NULL,NULL,'','','',NULL),('2018050804','2018-05-08','2','未结案',1,1,'1','Admin',NULL,NULL,'','','',NULL),('2018051301','2018-05-13','1','未结案',1,1,'1','1',NULL,NULL,'','','',1),('2018051401','2018-05-14','1','未结案',1,1,'1','Admin',NULL,NULL,NULL,NULL,'',0),('2018051402','2018-05-14','1','未结案',1,1,'1','Admin',NULL,NULL,'','','',1),('2018051403','2018-05-14','1','未结案',1,1,'','',NULL,NULL,'','','',0),('2018051404','2018-05-14','1','未结案',1,1,'1','1',NULL,NULL,'','','',1),('2018051601','2018-05-16','1','未结案',1,1,'1','1',NULL,NULL,'','','',1);
...
insert  into `requisitions_detail`(`serNO`,`billNo`,`prodID`,`prodName`,`predSize`,`unitName`,`sQuantity`,`currID`,`sPrice`,`amount`,`lastestCurrID`,`lastestPrice`,`lastestsPrice`,`preInDate`,`suggestPurDate`,`qtyRemain`,`itemRemark`,`tranType`,`tranNO`,`deleteStatus`) values (1,'2018050201','C01-W-HP-DC7900-307','HP DC7900CMT-NA307PA#AB2台式机','','PCS',3,'RMB',3370,3370,'RMB',3370,3370,'2018-05-02','2018-04-22',1,'itemRemark','','',1),(2,'2018050202','C01-W-HP-DC7900-308','HP DC7900CMT-NA308PA#AB2台式机','','PCS',2,'RMB',3370,3370,'RMB',3370,3370,'2018-05-02','2018-04-22',1,'itemRemark','','',1),(3,'2018050202','C01-W-HP-DC7900-308','HP DC7900CMT-NA308PA#AB2台式机','','PCS',2,'RMB',3370,3370,'RMB',3370,3370,'2018-05-02','2018-04-22',1,'itemRemark','','',1),(5,'2018050803','C01-W-HP-DC7900-307','HP DC7900CMT-NA307PA#AB2台式机','','PCS',3,'RMB',3370,0,'RMB',3370,3370,'2018-05-01','2018-05-01',1,'','','',1),(6,'2018050804','C01-W-HP-DC7900-307','HP DC7900CMT-NA307PA#AB2台式机','','PCS',2,'RMB',3370,0,'RMB',3370,3370,'2015-05-02','2015-05-02',1,'','','',1),(7,'2018050203','C01-W-HP-DC7900-307','HP DC7900CMT-NA307PA#AB2台式机','','PCS',1,'RMB',3370,0,'RMB',3370,3370,'2018-05-15','2018-05-14',1,'','','',1),(8,'2018051402','C01-W-HP-DC7900-307','HP DC7900CMT-NA307PA#AB2台式机','','PCS',1,'RMB',3370,0,'RMB',3370,3370,'2018-05-18','2018-05-13',1,'','','',1),(9,'2018051601','C01-W-HP-DC7900-307','HP DC7900CMT-NA307PA#AB2台式机','','PCS',1,'RMB',3370,0,'RMB',3370,3370,'2018-05-15','2018-05-10',1,'','','',1),(10,'2018051301','C01-W-HP-DC7900-307','HP DC7900CMT-NA307PA#AB2台式机','','PCS',1,'RMB',3370,3370,'RMB',3370,3370,'2018-05-15','2018-05-10',1,'','','',1),(11,'2018051404','C01-W-HP-DC7900-307','HP DC7900CMT-NA307PA#AB2台式机','','PCS',1,'RMB',3370,3370,'RMB',3370,3370,'2018-05-15','2018-05-10',1,'','','',1);
...
CREATE TABLE `s_sell_quote` (
  ...
  `quCid` varchar(50) DEFAULT NULL COMMENT '2、客户编号id',
  `quCname` varchar(50) DEFAULT NULL COMMENT '3、客户名称',
  `quCtype` varchar(50) DEFAULT NULL COMMENT '2.5客户类别',
  `quCaddressId` int(11) DEFAULT NULL COMMENT '4、送货地址id',
...
insert  into `s_sell_quote`(`quId`,`quCid`,`quCname`,`quCtype`,`quCaddressId`,`quCaddress`,`quDate`,`quEffectdate`,`quPricetax`,`quMoneytype`,`quExchangerate`,`quPeoywId`,`quPeoywName`,`quEmpId`,`quEmpName`,`quPerzdId`,`quPerzdName`,`quPerckId`,`quPerckName`,`quCheckstatus`) values ('20180512001','12','21','1',NULL,'21','2018-05-12','2018-05-12',21,'21',21,21,'21',21,'12',12,'21',21,'12',1),('20180512002','12','12','1',NULL,'12','2018-05-12','2018-05-12',12,'12',12,NULL,NULL,NULL,'2',NULL,NULL,NULL,NULL,1),('2018051301','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'',NULL,'',NULL,'销售部',1),('2018051302','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'',NULL,'',NULL,'销售部',1),('2018051303','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'',NULL,'',NULL,'销售部',1),('2018051304','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'13',NULL,'23',NULL,'销售部',1),('2018051305','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'',NULL,'',NULL,'销售部',1),('2018051307','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'',NULL,'',NULL,'销售部',1),('2018051308','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'21',NULL,'12',NULL,'销售部',0),('2018051309','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'12',NULL,'12',NULL,'销售部',0),('2018051310','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'销售部',NULL,'飞洒',NULL,'水电费',NULL,'销售部',0),('2018051311','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'业务',NULL,'销售部',NULL,'制单',NULL,'审核',0),('2018051312','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'我',NULL,'你',0),('2018051313','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'啊',NULL,'是',0),('2018051314','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'',NULL,'',0),('2018051315','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'',NULL,'',0),('2018051316','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'234',NULL,'234',0),('2018051317','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路1','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'',NULL,'',0),('2018051318','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',1,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'',NULL,'',0),('2018051319','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin213',NULL,'销售部132',NULL,'13',NULL,'123',0),('2018051320','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路123','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'',NULL,'',0),('2018051321','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路3324','2018-05-13','2018-05-13',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'234',NULL,'342',0),('2018051401','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-14','2018-05-14',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'',NULL,'',0),('2018051402','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-14','2018-05-14',1,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'12',NULL,'',0),('2018051403','200903K00001','株洲伟大','0',1024001,'株洲市天元区黄山路','2018-05-14','2018-05-14',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'123',NULL,'1',0),('2018051404','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-14','2018-05-14',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'1',NULL,'2',0),('2018051405','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-14','2018-05-14',1,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'是',NULL,'爱上',0),('2018051406','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-14','2018-05-14',1,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'12',NULL,'12',0),('2018051407','200903K00001','株洲伟大','1',1024001,'株洲市天元区黄山路','2018-05-14','2018-05-14',0,'人民币',1,NULL,'Admin',NULL,'销售部',NULL,'',NULL,'',0);
...
CREATE TABLE `s_sell_quoteparticular` (
  ...
  `qpLargess` varchar(11) DEFAULT NULL COMMENT '赠品  （1代表是、0代表否）',
...
insert  into `s_sell_quoteparticular`(`qpId`,`qpQuid`,`qpMaterielid`,`qpMaterielname`,`qpModel`,`qpUnitname`,`qpNumber`,`qpDiscountprice`,`qpDiscount`,`qpPrice`,`qpSum`,`qpRate`,`qpTatemoney`,`qpTotalmoney`,`qpLargess`,`qpRemark`) values (1,'20180512001','123','213','213','123',21,21,21,21,1,NULL,NULL,NULL,NULL,NULL),(2,'20180512002','23','213','132','32',21,21,2,12,1,NULL,NULL,NULL,NULL,NULL),(3,'2018051302','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(4,'2018051303','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(5,'2018051303','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(6,'2018051303','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(7,'2018051303','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(8,'2018051303','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(9,'2018051304','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(10,'2018051304','1','0','1','1',2,2,2,2,1,2,2,1,'2','1'),(11,'2018051304','1','0','1','1',3,3,3,3,1,3,3,1,'1','1'),(12,'2018051305','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(13,'2018051305','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(17,'2018051307','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(18,'2018051307','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(19,'2018051308','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(20,'2018051308','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(21,'2018051309','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(22,'2018051309','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(23,'2018051310','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(24,'2018051311','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(25,'2018051312','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(26,'2018051313','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(27,'2018051314','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(28,'2018051315','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(425,'2018051316','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(426,'2018051316','1','0','1','1',134,1,0,0,1,1,1,1,'1','1'),(427,'2018051316','1','0','1','1',24,1,0,0,1,1,1,1,'1','1'),(428,'2018051316','1','0','1','1',234,1,0,0,1,1,1,1,'1','1'),(429,'2018051316','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(430,'2018051316','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(431,'2018051316','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(432,'2018051316','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(433,'2018051316','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(434,'2018051316','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(437,'2018051317','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(438,'2018051317','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(439,'2018051317','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(444,'2018051318','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(445,'2018051318','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(446,'2018051319','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(447,'2018051319','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(448,'2018051319','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(453,'2018051320','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(454,'2018051320','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(455,'2018051320','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(456,'2018051320','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(472,'2018051321','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(473,'2018051321','1','0','1','1',1,13,0,0,1,1,1,1,'1','1'),(474,'2018051321','1','0','1','1',1,123,23,0,1,1,1,1,'1','1'),(475,'2018051321','1','0','1','1',1,123,0,0,1,1,1,1,'1','1'),(476,'2018051321','1','0','1','1',1,123,0,0,1,1,1,1,'1','1'),(477,'2018051321','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(479,'2018051401','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(483,'2018051402','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(484,'2018051402','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(485,'2018051402','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(486,'2018051403','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(487,'2018051404','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(488,'2018051404','1','0','1','1',1,1,2,2,1,1,1,1,'1','1'),(489,'2018051405','1','0','1','1',1,1,0,0,1,1,1,1,'1','1'),(490,'2018051406','1','0','1','1',20,1,0,0,1,1,1,1,'1','1'),(491,'2018051406','1','0','1','1',90,1,0,0,1,1,1,1,'1','1'),(500,'2018051407','1','0','1','1',1,1,0,0,1,1,1,1,'1','1');
...
insert  into `t_vendor_masterfile_address`(`AddrID`,`Address`,`ZipCode`,`LinkMan`,`LinkManProf`,`Telephone`,`FaxNo`,`WalkAddr`,`Memo`,`addressId`) values (1024001,'株洲市天元区黄山路','1026','潘盈安','员工','17673246089',NULL,NULL,NULL,'CSXL');
...
insert  into `takeprepay`(`Qy_ID`,`MoneyPayableID`,`SourceName`,`SourceID`,`CurpreRecv`,`DepartID`,`DepartName`,`OrigprepayUsed`,`Remark`) values ('12123','2','1','1',1.0000,1,'1',1.0000,'1'),('20141225001','MoneyPayabl','SourceName','SourceID',0.0000,0,'DepartName',0.0000,'Remark');
